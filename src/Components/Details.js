...
class Details extends React.Component{
    ...
    componentDidMount (){
        ...
        axios({
            url: `https://quiet-sierra-40851/restaurantdetails/${restaurantId}`,
            method:"GET",
    ...
    handleOrder= () => {
        ...
        axios({
            url: `https://quiet-sierra-40851/menuItems/${restaurantId}`,
            method:"GET",
            Headers:{'Content-Type': 'application/json'}
         }).then(response =>{
    ...
    getData = (data) => {
        return fetch(`https://quiet-sierra-40851/payment`, {
            method: "POST",
            headers: {
